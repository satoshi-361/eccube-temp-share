...
class RecommendSearchModelController extends AbstractController
{
     ...
     *
     * @return array
     * @Route("/%eccube_admin_route%/plugin/top_banner/search/product", name="plugin_top_banner_search_product")
     * @Route("/%eccube_admin_route%/plugin/top_banner/search/product/page/{page_no}", requirements={"page_no" = "\d+"}, name="plugin_top_banner_search_product_page")
     * @Template("@TopBanner/admin/search_product.twig")
     */
