...
namespace Plugin\TopBanner\Entity;
 ...
 * RecommendProduct
 *
 * @ORM\Table(name="plg_top_banner_product")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Plugin\TopBanner\Repository\RecommendProductRepository")
 */
