...
namespace Plugin\Pickup4\Tests\Web;
...
class RecommendAdminControllerTest extends AbstractAdminWebTestCase
{
    ...
    {
        parent::setUp();
        $this->deleteAllRows(['plg_pickup_product']);
    ...
    {
        $this->deleteAllRows(['plg_pickup_product']);
        $crawler = $this->client->request('GET', $this->generateUrl('plugin_pickup_list'));
    ...
    {
        $crawler = $this->client->request('GET', $this->generateUrl('plugin_pickup_new'));
        $this->assertContains('ピックアップ商品管理', $crawler->html());
    }
    ...
    public function testRecommendNewEmpty()
    {
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_new'),
            ['recommend_product' => [
                '_token' => 'dummy',
                'comment' => '',
                'Product' => '',
    ...
    public function testRecommendNew()
    {
        ...
        $this->assertTrue($this->client->getResponse()->isRedirect($this->generateUrl('plugin_pickup_list')));
    ...
    public function testAjaxSearchPublicProduct()
    {
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_search_product', ['id' => '', 'category_id' => '', '_token' => 'dummy']),
            [],
            [],
    ...
    public function testAjaxSearchUnpublicProduct()
    {
        ...
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_search_product', ['id' => '彩のジェラートCUBE', 'category_id' => '', '_token' => 'dummy']),
            [],
            [],
            ['HTTP_X-Requested-With' => 'XMLHttpRequest']
        );
    ...
    public function testAjaxSearchProductValueCode()
    {
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_search_product', ['id' => '	cube-01', 'category_id' => '', '_token' => 'dummy']),
            [],
            [],
            ['HTTP_X-Requested-With' => 'XMLHttpRequest']
        );
    ...
    public function testAjaxSearchProductValueId()
    {
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_search_product', ['id' => 1, 'category_id' => '', '_token' => 'dummy']),
            [],
            [],
            ['HTTP_X-Requested-With' => 'XMLHttpRequest']
        );
    ...
    public function testAjaxSearchProductCategory()
    {
        $crawler = $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_search_product', ['id' => '', 'category_id' => 3, '_token' => 'dummy']),
            [],
            [],
            ['HTTP_X-Requested-With' => 'XMLHttpRequest']
        );
    ...
    public function testRecommendEditShow()
    {
        ...
        $crawler = $this->client->request('GET', $this->generateUrl('plugin_pickup_edit', ['id' => $recommendId]));
    ...
    public function testRecommendEdit()
    {
        ...
        $this->client->request(
            'POST',
            $this->generateUrl('plugin_pickup_edit', ['id' => $recommendId]),
            [
                'recommend_product' => [
                    '_token' => 'dummy',
                    'comment' => $editMessage,
    ...
    public function testRecommendDelete()
    {
        ...
        $this->client->request(
            'DELETE',
            $this->generateUrl('plugin_pickup_delete', ['id' => $recommendId])
        );
        $this->assertTrue($this->client->getResponse()->isRedirect($this->generateUrl('plugin_pickup_list')));
     ...
     * @param $rank
     *
     * @return \Plugin\Pickup4\Entity\RecommendProduct
     */
    private function initRecommendData($productId, $rank)
    {
        ...
        $Recommend = new \Plugin\Pickup4\Entity\RecommendProduct();
