...
class RecommendSearchModelController extends AbstractController
{
     ...
     *
     * @return array
     * @Route("/%eccube_admin_route%/plugin/pickup/search/product", name="plugin_pickup_search_product")
     * @Route("/%eccube_admin_route%/plugin/pickup/search/product/page/{page_no}", requirements={"page_no" = "\d+"}, name="plugin_pickup_search_product_page")
     * @Template("@Pickup4/admin/search_product.twig")
     */
