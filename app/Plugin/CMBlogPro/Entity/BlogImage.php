...
if (!class_exists('\Plugin\CMBlogPro\Entity\BlogImage')) {
    /**
     * BlogImage
     *
     * @ORM\Table(name="plg_blog_image2")
     * @ORM\InheritanceType("SINGLE_TABLE")
     * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
     * @ORM\HasLifecycleCallbacks()
     * @ORM\Entity(repositoryClass="\Plugin\CMBlogPro\Repository\BlogImageRepository")
     */
    class BlogImage extends \Eccube\Entity\AbstractEntity
    {
         ...
         *
         * @ORM\ManyToOne(targetEntity="\Plugin\CMBlogPro\Entity\Blog", inversedBy="BlogImage")
         * @ORM\JoinColumns({
