...
class ProductController extends AbstractController
{
     ...
     * 商品一覧画面.
     *
     * @Route("/blogs/list", name="product_list", methods={"GET"})
     ...
     * 商品詳細画面.
     *
     * @Route("/blogs/detail/{id}", name="product_detail", methods={"GET"}, requirements={"id" = "\d+"})
    ...
    public function detail(Request $request, Product $Product)
    {
        ...
        $affiliateParam = $Customer ? $Customer->getSalt() . $Product->getId() : '';
     ...
     * お気に入り追加.
     *
     * @Route("/blogs/add_favorite/{id}", name="product_add_favorite", requirements={"id" = "\d+"}, methods={"GET", "POST"})
     */
     ...
     * カートに追加.
     *
     * @Route("/blogs/add_cart/{id}", name="product_add_cart", methods={"POST"}, requirements={"id" = "\d+"})
     */
    ...
    /**
     * @Route("/blogs/affiliate/{url}", name="blog_affiliate", methods={"GET"})
     */
    public function affiliate(Request $request, $url = null)
    {
        $salt = substr($url, 0, 10);
        $blogId = substr($url, 10);
     ...
     * @Template("Product/profile.twig")
     */
    public function profile(Request $request, PaginatorInterface $paginator, $id = null)
    {
